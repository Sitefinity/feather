...
namespace Telerik.Sitefinity.Frontend.Test.GridSystem
{
    ...
    {
        #region GetOrCreateToolBoxSection
        ...
        #region CreateLayoutControlsData
        ...
        public void CreateLayoutControlsData_FakeTemplatePath_VerifyControlsAreProperlyCreated()
        {
            ...
            Assert.AreEqual<int>(10, dummyData.Count, "CreateLayoutControlsData method should return 10 items.");
