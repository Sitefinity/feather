...
using Telerik.Sitefinity.Frontend.TestUI.Framework.Framework.Wrappers.Backend.Modules;
...
namespace Telerik.Sitefinity.Frontend.TestUI.Framework.Wrappers.Backend
{
    ...
    public class BackendWrappersFacade
    {
        ...
        /// <summary>
        /// Provides access to the Frontend Module Wrapper.
        /// </summary>
        /// <returns>Frontend module facade.</returns>
        public FrontendModuleWrapperFacade FrontendModule()
        {
            return new FrontendModuleWrapperFacade();
        }
    }
}
