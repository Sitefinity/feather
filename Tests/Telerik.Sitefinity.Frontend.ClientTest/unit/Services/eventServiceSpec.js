/* Tests for sf-event-service.js */
describe('sfEventService', function () {
    var $httpBackend;
    var dataService;
    var dataItems = {
        Items: [{
    ...
    beforeEach(inject(function ($injector) {
        ...
        dataService = $injector.get('sfEventService');
    }));
    ...
    it('[EGaneva] / should return single item.', function () {
        $httpBackend.expectGET('http://mysite.com:9999/myapp/Sitefinity/Services/Content/EventService.svc/4c003fb0-2a77-61ec-be54-ff00007864f4/?provider=OpenAccessDataProvider&published=true')
        .respond(dataItems);
    ...
    it('[EGaneva] / should retrieve specific items.', function () {
        $httpBackend.expectGET('http://mysite.com:9999/myapp/Sitefinity/Services/Content/EventService.svc/?filter=Visible%3D%3Dtrue+AND+Status%3D%3Dlive+AND+(Id%3D4c003fb0-2a77-61ec-be54-ff00007864f4)&itemSurrogateType=Telerik.Sitefinity.GenericContent.Model.Content&itemType=Telerik.Sitefinity.GenericContent.Model.Content&skip=0&take=100')
                    .respond(filterItems);
    ...
    it('[EGaneva] / should return error.', function () {
        $httpBackend.expectGET('http://mysite.com:9999/myapp/Sitefinity/Services/Content/EventService.svc/4c003fb0-2a77-61ec-be54-ff0000000000/?published=true')
