...
namespace Telerik.Sitefinity.Frontend.TestUI.TestCases.Module
{
    ...
    /// </summary>
    [TestClass]
    public class UninstallFeatherAndDeleteWidgetFromHybridPageTemplate_ : FeatherTestCase
    {
        /// <summary>
        ...
        public void UninstallFeatherAndDeleteWidgetFromHybridPageTemplate()
        {
            ...
            try
            {
                ...
                RuntimeSettingsModificator.ExecuteWithClientTimeout(ClientTimeoutInterval, () => BAT.Macros().NavigateTo().CustomPage(PageTemplatesPageUrl, false));
        ...
        private const string PageName = "Page_UninstallFeatherAndDeleteWidgetFromHybridPageTemplate";
        private const string PageTemplateName = "Template_UninstallFeatherAndDeleteWidgetFromHybridPageTemplate";
