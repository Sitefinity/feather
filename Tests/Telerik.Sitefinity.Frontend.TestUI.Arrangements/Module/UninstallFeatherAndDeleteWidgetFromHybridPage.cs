...
{
    /// <summary>
    /// UninstallFeatherAndDeleteWidgetFromHybridPage arragement.
    /// </summary>
    public class UninstallFeatherAndDeleteWidgetFromHybridPage : ITestArrangement
    {
        /// <summary>
        /// Server side set up. 
        /// </summary>
        ...
        private const string PageTemplateName = "Template_UninstallFeatherAndDeleteWidgetFromHybridPage";
    }
}
