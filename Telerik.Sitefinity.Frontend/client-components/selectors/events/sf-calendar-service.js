(function () {
    ...
    .factory('sfCalendarService', ['serviceHelper', 'serverContext', function (serviceHelper, serverContext) {
        var dataItemPromise,
            contentType = 'Telerik.Sitefinity.GenericContent.Model.Content',
            serviceUrl = serverContext.getRootedUrl('Sitefinity/Services/Content/CalendarService.svc/');
