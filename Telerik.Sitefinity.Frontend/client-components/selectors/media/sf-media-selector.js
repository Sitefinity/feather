(function ($) {
    ...
    sfMediaSelector.directive('sfMediaSelector',
                        ...
                        var openUploadPropertiesDialog = function (file) {
                            ...
                            angular.element('.uploadPropertiesModal')
                                ...
                                .$openModalDialog({
                                    ...
                                    videoElement.id = "video-el-preview-for-upload";
                                    videoElement.src = URL.createObjectURL(file);
                                    videoElement.style.width = "100%";

                                    var fileSelectedNode = document.querySelector('body > div.modal.fade.ng-isolate-scope.sf-designer-dlg.sf-timespan-selector-dlg.sf-backend-wrp.modal-dialog-2.in > div > div > div.modal-body.ng-scope > div:nth-child(1) > div');
                                    fileSelectedNode.parentElement.insertBefore(videoElement, fileSelectedNode);
                                    videoElement.load();
                                })
        ...
        */
        ...
        .controller('SfMediaSelectorUploadPropertiesCtrl', ['$scope', '$uibModalInstance', 'sfMediaService', 'sfFileModel', 'sfProvider', 'sfLabels',
            function myfunction($scope, $uibModalInstance, sfMediaService, sfFileModel, sfProvider, sfLabels) {
