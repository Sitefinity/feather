...
(function ($) {
    ...
    //designerModule.controller('GridDialogCtrl', ['$rootScope', '$scope', '$q', '$modalInstance', '$route', 'serverData', 'gridService',
    //function ($rootScope, $scope, $q, $modalInstance, $route, serverData, gridService) {
