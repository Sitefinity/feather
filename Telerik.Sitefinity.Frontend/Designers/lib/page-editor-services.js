 ...
 * the page and so on.
 */
pageEditorServices.provider('widgetContext', function WidgetContext() {
...
pageEditorServices.factory('propertyService', function ($rootScope, $http, $q, widgetContext) {
	...
	var service = {
		 ...
		 *
		 * @param {Number} saveMode The type of save that should be performed. 0 - default, 1 - all translations, 2 - currently transaltion only
