...
(function (sf) {
    ...
    sf.pageEditor = {
        ...
        openDialog: function (ev, args) {
            ...
            var dialogUrl = args.url;

            // TODO: remove everything within this if and if itself
            if (args && args.url) {
                this.getService().factory('PageControlDataService', function () {
                    return {
                        data: args
                    };
                });
        ...
        /**
         * Gets the page editor service.
         */
        getService: function () {
            return angular.module('pageEditorServices');
        }
    };
})(sf);
